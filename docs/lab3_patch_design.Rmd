...
`for (package in c("dplyr","ggplot2","raster","sp","rgdal","maptools","rgeos","maps","GISTools")) {`
...
# Plot it with raster package which uses base R plotting:
plot(hood_nlcd)
...
Note that the legend is correct for the colors but the mapping to pixels in the plot itself is not. See if you can figure out how to fix this (Optional for this lab).
```{r, message=FALSE, results='hide',warning=FALSE, fig.width=6, fig.height=8}
