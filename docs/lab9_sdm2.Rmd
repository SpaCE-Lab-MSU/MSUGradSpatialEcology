...
*NOTE 1:* Older versions of WorldClim data (version 1.4) can be downloaded directly using getData. Note that these data are outdated so you wouldn't want to publish anything with them. We are working on code for you to reference with the updated WorldClim 2.1 data but for the lab exercises, feel free to use 1.4 like this:
