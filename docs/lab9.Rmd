...
It is possible that the dismo vignette is using older versions of WorldClim data (version 1.4). The version 1.4 data are outdated so you wouldn't want to publish anything with them. See above for how to obtain the updated data (2.1). For the lab exercises, it's ok to use the 1.4 version; you can download 1.4 version data from another area like this:
