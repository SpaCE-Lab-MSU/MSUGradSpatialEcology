...
**Second**, complete the *Start working in R:*. The code below is modified from the Vignette, *[Exploring spatial data in R](FOR870_Lab5_spatialdataviz_variograms.pdf)* by Andrew Finley (MSU; https://www.finley-lab.com) and Sudipto Banerjee (UCLA; http://sudipto.bol.ucla.edu/). See the vignette for more context.

**Third**, after completing the *Start working in R:*, answer the 3 Questions at the end of the lab.
...
Want to fit a variogram function for just one? In this case, shown for 45°.
```{r, message=FALSE, results='hide',warning=FALSE}
