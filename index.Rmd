...
These are the lab exercises for the MSU Graduate course in Spatial Ecology, Fall 2020 (FOR870). Labs will be posted as we go through the semester. The labs are generally mixtures of lecture, code, and results. Most labs have exercises for you to produce working code, and will require R and RStudio. Please read the instructions under "LAB" on D2L, and on the Syllabus, for due dates, how to submit your Lab assignments, and expectations.
