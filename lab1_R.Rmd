...
This lab has 3 Parts. Note that you only need to hand in Part 3 (Stommel Diagram), due in the D2L Lab 1 Drop Box by start of Lab 2. 
...
There are numerous tutorials, books, short courses, etc. out there to help you learn R. See the resources in the course D2L folder, "Resources" for just a few relevant links to help you beyond this course. There are also resources posted on the MSU SpaCE Lab website at: https://space-lab-msu.github.io/r_guide/. The exercises below draw on bits and pieces from some of these sources, but also some aspects that I think are particularly important to understand about R. Even if you’ve worked with R before, you may find some of these descriptions and codes useful. I’m always learning new things in R from a variety of sources - from my students, postdocs, and colleagues, and from websites and scientific papers and conferences. 

### FAIR Principles

Data should be Findable, Accessible, Interoperable, and Reusable (FAIR). Read Wilkinson et al. (2016) to become familiar with these standards. 
...
Set paths for the location where the data exist (these directories (folders) must already exist, and will be different than the folder names below, which are for my location on my computer).
...
# be helpful to install the package locally first (run this before knitting)
...
If you and/or your lab partner would like more practice, complete Part 2 of this lab. You don't need to hand in anything for this portion of the lab. 
If you AND your lab partner(s) are already pros at ggplot2 and R, you can skip this and begin working on Part 3 and the Homework prep for Lab 2. 

Data for the following exercise is on D2L in the Lab 1 folder.
