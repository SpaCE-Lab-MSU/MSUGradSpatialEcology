...
We will be using the R package, "landscapemetrics" to compute patch metrics. Before we can do that, we need to obtain the data.
...
NOTE: If the installation for FedData doesn't work for you, I have included another way to get NLCD data for Oregon, below.
...
If you have trouble with the `FedData` package, here is where you will import the 2011 Oregon NLCD directly (54 MB); it may take a few mins. Uncomment the code below.
```{r, message=FALSE, results='hide',warning=FALSE}
