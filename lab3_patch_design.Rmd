...
plot(mgmt1)
plot(hood,add=T,col="red", main="Hood Wildlife Management Unit, Oregon")
```
...
correlations<-calculate_correlation(hood_metrics)
show_correlation(correlations, method = "pearson")
```
