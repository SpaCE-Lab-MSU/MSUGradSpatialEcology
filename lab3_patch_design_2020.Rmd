...
date: "Sep 2016; rev. Sep 9, 2019, Sep 17-21, 2020"
urlcolor: blue
---
...
`for (package in c("dplyr","ggplot2","raster","sp","rgdal","maptools","rgeos","GISTools")) {`
...
if(! file.exists(mgmt_file)){
 download.file("https://nrimp.dfw.state.or.us/web%20stores/data%20libraries/files/ODFW/ODFW_805_5_wildlife_mgmt_units.zip",dest=mgmt_file, mode="wb") 
}
