...
This lab has 2 Parts. You need to hand in Part 1&2 as a PDF produced from R Markdown, including output plots, statistics, code, and text for answers to the questions below. Submit to D2L Lab 4 Assignment  by the start of Lab 5. When referring to the code below it may be more useful to use the .Rmd file associated with the PDF.

# Part 1: Moran's I
A. Generate global Moran's I statistic for Elevation in the brycesite data used in our Lab 1: http://ecology.msu.montana.edu/labdsv/R/labs/lab2/lab2.html. 
east=easting; north=northing. Use "Moran.I" in package "ape". Check assumptions and transform your data if necessary.

# Moran's I in package `ape` 
Note that I'm commenting out the output in the code below; you will need to run this in R to see the output.
...
`for (package in c("ape", "ncf", "ggplot2", "sp", "labdsv", "ggmap", "proj4", "rgdal")) {`
...
Read in data
```{r, message=FALSE, results='hide',warning=FALSE}
# Call the data directly because it's loaded in labdsv
data(brycesite)

## If you wanted to read it in, you would do so this way:
...
# The plot above doesn't have a legend, a north arrow, or a scalebar. Add those.
...
# Add a north arrow with GISTools package
north.arrow(x=-13565000, y=5730000, len = 1000, cex.lab = 0.75, col = "black", fg = "red")
