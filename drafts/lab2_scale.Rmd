...
# In order to work on these R Markdown files on your own computer, first create a folder for this course (something like "MSUGradSpatialEcology"). Then, download this .Rmd file into that folder. This will be your root folder for all lab work. The code below will create a subdirectory in this folder called, "data". 
