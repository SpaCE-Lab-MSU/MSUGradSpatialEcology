...
```
It might take time to import the occurence data on puma through gbif. Alternatively, and for the purpose of this lab only, you can download the same data avalaible in the <a href="https://github.com/SpaCE-Lab-MSU/MSUGradSpatialEcology/tree/master/docs">"data/lab2" folder on GitHub</a> and store it in your data_path. This data was last updated on September 2025.
To load the data, copy this into your R console:
puma.gbif <- readr::read_delim(file.path("data/lab2/puma_concolor.csv"), delim = "\t", escape_double = FALSE,trim_ws =TRUE)
