...
This lab covers connectivity analysis with the `grainscape` R package. I have also included some extra OPTIONAL exercises at the end of the lab on interpolation with the `gstat` R package used in lab 5.
