...
date: "Sep 2015; rev. Sep 24, 2019, Sep 23-27, 2020"
urlcolor: blue
---
...
Next, choose a NEW VARIABLE from the `site` dataframe. Plot the variable in space (see the code for plotting elevation on a map, above). The variable list for the site variables is here: https://www.rdocumentation.org/packages/labdsv/versions/2.0-1/topics/brycesite.
